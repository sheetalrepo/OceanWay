...
//ref: https://www.sanfoundry.com/java-program-implement-checksum-method-small-string-messages-detect-if-received-message-same-transmitted/
public class Checksum
{
    public static void main(String args[])
    {
        Scanner scan = new Scanner(System.in);
        System.out.println("Enter the string input:");    // Hello
        ...
        System.out.println("Enter the data to be sent:");   // Hello
        input = scan.next();
        System.out.println("Enter the checksum to be sent:");   // 4abf

package b_collections.d_wildcard;
...
/**
 * Collections.copy implementation
 * <Number> void java.util.Collections.copy(List<? super Number> dest, List<? extends Number> src)
 * 
 * refer: https://stackoverflow.com/questions/2776975/how-can-i-add-to-list-extends-number-data-structures
 */
public class Test {

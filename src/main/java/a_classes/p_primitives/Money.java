package a_classes.p_primitives;
...
public class Money {
	...
	public static void OneCandyLessFinalSolution() {
		BigDecimal walletBalance = new BigDecimal("1.00");  // String prevents floating-point issues
		BigDecimal candyPrice = new BigDecimal("0.10");

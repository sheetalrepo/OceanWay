 ...
 * 
 * 
 * If List<Dog> were allowed as List<Animal>, someone could add a different subtype of Animal (e.g., Cat) to the list.
 * 
 * 
...
public class PolymorphicArrayLists {
	...
	public static void main(String [] args){
		...
		//java stopped developer at compiler time else we may get runtime exception
		// if someone added "list.add(new BigCat())" in method (line 46)
	}

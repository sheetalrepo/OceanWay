...
//
//public class JavaFundamentalsSolution2 {
...
//        } else {
//            System.out.println("The parametered text was this --> " + text + " <--");
//        }
//    }
//
...
//        //String [] weekInEnglish={"Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"};
//        //String [] weekInHungarian={"Hétfő","Kedd","Szerda","Csütörtök","Péntek","Szombat","Vasárnap"};
//        //if (nameOfDayInEnglish=="Sunday")
//        String nameOfDayInHungarian = null;
//        if (nameOfDayInEnglish == null) {
//            nameOfDayInHungarian = "Parameter is not an English day name starting with capital letter.";
//        } else
//            switch (nameOfDayInEnglish) {
//                case "Monday":
//                    nameOfDayInHungarian = "Hétfő";
//                    break;
//                case "Sunday":
//                    nameOfDayInHungarian = "Vasárnap";
//                    break;
//                case "Tuesday":
//                    nameOfDayInHungarian = "Kedd";
//                    break;
//                case "Wednesday":
//                    nameOfDayInHungarian = "Szerda";
//                    break;
//                case "Thursday":
//                    nameOfDayInHungarian = "Csütörtök";
//                    break;
//                case "Friday":
//                    nameOfDayInHungarian = "Péntek";
//                    break;
//                case "Saturday":
//                    nameOfDayInHungarian = "Szombat";
//                    break;
//                default:
//                    nameOfDayInHungarian = "Parameter is not an English day name starting with capital letter.";
//            }
//        return nameOfDayInHungarian;
//
//    }
//
...
//        if (text == null) {
//            return false;
//        } else if ((text.contains("a") || text.contains("b") || text.contains("c")) && !(text.contains("x") || text.contains("y") || text.contains("z"))) {
//            return true;
//        }
//        return false;
//    }
...
//        // TODO: Implement function here
//        if (numbers == null) {
//            System.out.println("The parameter was null.");
//            return null;
//        }
//        if (numbers.length == 0) {
//            System.out.println("The parameter was an empty array.");
//            return 0;
//        }
//        {
//            int max;
//            boolean existNonPositive = false;
//            max = numbers[0];
//            for (int i = 0; i < numbers.length; i++) {
//                max = Math.max(max, numbers[i]);
//                if (numbers[i] < 0) {
//                    existNonPositive = true;
//                }
//            }
//            if (max <= 0) {
//                System.out.println("Every numbers was non-positive.");
//                return 0;
//            }
//            if (existNonPositive) {
//                System.out.println("Not every number was positive.");
//            }
//            return max;
//        }
//    }
...
//        // boolean isContain = text.contains(character);
...
//        int index = getIndexOfFirstAppearanceOfCharInString(text, character);
//        if (index == 0) {
//            System.out.println("The '" + text + "' text doesn't contain the '" + character + "'");
//        } else {
//            System.out.println("The '" + text + "' text contains the '" + character + "' character, first at this index: " + index);
//        }
//    }
//
//
